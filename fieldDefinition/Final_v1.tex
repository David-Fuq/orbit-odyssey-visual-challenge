...
\centering
\begin{tikzpicture}
  % All field geometry inside a scaled scope; labels outside at normal size
  \begin{scope}[scale=0.055]
    % --- Field outline ---
    \draw[thick] (0,0) rectangle (254, 142.24);

    % --- Corner zones (30.48 x 30.48 cm) ---
    ...
    % --- Object positions (filled circles, r ~ 6 cm) ---
