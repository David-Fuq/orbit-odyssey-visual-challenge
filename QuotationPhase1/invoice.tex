...
\textbf{Invoice Number:} & INV-001 & \textbf{Date:} \today \\
\textbf{From:} & David Alejandro Fuquen & \\
\textbf{Bill To:} & Cornell CETC & \\
\textbf{Payment Terms:} & Due upon receipt & \\
\end{tabularx}

\vspace{1em}

\section*{Invoice for Phase 1 of the Orbit Odyssey - Computer Vision Autonomous Challenge}
...
\begin{enumerate}[leftmargin=*]
    ...
    \item \textbf{Final Revision and Corrections} (2 hrs)
    \begin{itemize}
...
Final revision and corrections & 2.0 & \$56.00 \\
\midrule
\textbf{Phase 1 Total} & \textbf{15.0} & \textbf{\$420.00} \\
\bottomrule
\end{tabular}
\end{center}
...
\begin{center}
\large\textbf{Amount Due: \$420.00}
\end{center}

\vspace{1.5em}

\noindent\fbox{\parbox{\dimexpr\textwidth-2\fboxsep-2\fboxrule}{%
\textbf{Payment Information} \\[0.5em]
\begin{tabular}{@{}ll@{}}
Bank Name:      & ACME National Bank \\
Account Holder: & David Alejandro Fuquen \\
Account Number: & 1234567890 \\
Routing Number (ABA): & 021000021 \\
Account Type:   & Checking \\
\end{tabular}
\\[0.5em]
\textit{Please reference invoice INV-001 in the transfer memo.}
}}
