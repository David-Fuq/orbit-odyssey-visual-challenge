...
\noindent\textbf{Deadline:} 26/05/2026 (to be shown at 10 AM HKT meeting) \hfill \textbf{Estimated hours:} 14 \hfill \textbf{Cost:} \$392.00
...
\begin{enumerate}[leftmargin=*]
    \item \textbf{Playing Field Definition} (4 hrs)
    \begin{itemize}
    ...
    \item \textbf{Scoring System and Scorecards} (4 hrs)
    \begin{itemize}
    ...
    \item \textbf{Anti-Cheating Documentation} (2 hrs)
    \begin{itemize}
...
\midrule
Playing field definition & 4 & \$98.00 \\
Scoring system \& scorecards & 4 & \$98.00 \\
Student guide & 2 & \$98.00 \\
Moderator guide & 2 & \$70.00 \\
Anti-cheating documentation & 2 & \$28.00 \\
\midrule
...
\noindent\textbf{Timeline:} To be delivered June 9-12 \hfill \textbf{Estimated hours:} 18 \hfill \textbf{Cost:} \$504.00
...
\begin{enumerate}[leftmargin=*]
    \item \textbf{CETC Code Integration} (7 hrs)
    \begin{itemize}
    ...
    \item \textbf{Signed Receipt System} (6 hrs)
    \begin{itemize}
    ...
    \item \textbf{UI Adjustments and Testing} (3 hrs)
    \begin{itemize}
...
\noindent\textbf{Timeline:} June 19-23 \hfill \textbf{Estimated hours:} 11 \hfill \textbf{Cost:} \$308.00
...
\begin{description}[leftmargin=!,labelwidth=5em]
    \item[26/05/2026] Complete competition manual. Deliver: finalized PDF with playing field specs, scoring rules, student/moderator guides, anti-cheat documentation, and printable scorecards.

    \item[June 9- June 12] CETC's training code integration and receipt system. Deliver: working GUI that produces encrypted receipts alongside trained models. Moderator decryption utility functional.

    \item[June 19 - June 23] XRP code finalization and full-pipeline integration testing. Deliver: updated \texttt{main.py}, tested end-to-end with physical hardware and competition objects.
\end{description}
